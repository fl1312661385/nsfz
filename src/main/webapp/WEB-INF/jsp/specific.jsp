...
<body>
  ...
  <div class="content content-nav-base commodity-content">
        ...
        <div class="right-cont-wrap">
          <div class="right-cont">
            ...
            <div class="cont-list layui-clear" id="list-cont">
             ...
             <c:forEach items="${kindofproduct}" var="i" begin="${(util.currentPage-1)*util.pageSize }" end="${util.pageSize * util.currentPage-1}" step="1">
   ...
   <a href="specific?type=${type }&currentPage=${util.currentPage-1}" class="layui-btn layui-btn-warm">上一页</a>
          </c:if>
     ...
     <c:if test="${util.currentPage<util.lastPage}" >
           <a href="specific?type=${type }&currentPage=${util.currentPage+1}" class="layui-btn layui-btn-warm" >下一页</a>
            </c:if>
            </div>
          </div>
        </div>
