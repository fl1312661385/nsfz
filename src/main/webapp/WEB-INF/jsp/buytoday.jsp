        ...
        <div class="inner-cont0">
          <div class="inner-cont1 w1200">
            <div class="inner-cont2">
              ...
              <a href="buytoday" class="active">今日团购</a>
         ...
         <div class="tab-title">
          ...
          <div class="list-cont" cont = 'tuangou'>
            <div class="item-box layui-clear">
              <div class="item">
               <a href="details?productId=25"> <img src="img/tuan_img1.jpg" alt=""></a>
             <!--    <img src="img/tuan_img1.jpg" alt=""> -->
              ...
              <div class="item">
               <a href="details?productId=26"> <img src="img/tuan_img2.jpg" alt=""></a>
                <!-- <img src="img/tuan_img2.jpg" alt=""> -->
                <div class="text-box">
                  <p class="title">宝宝专用硅胶环保饭碗四套+调羹+筷子自助学吃饭套装</p>
                  <p class="plic">
                    <span class="ciur-pic">￥100.00</span>
              ...
              <div class="item">
               <a href="details?productId=27"> <img src="img/tuan_img3.jpg" alt=""></a>
                <!-- <img src="img/tuan_img3.jpg" alt=""> -->
                <div class="text-box">
                  <p class="title">宝宝专用硅胶环保饭碗四套+调羹+筷子自助学吃饭套装</p>
                  <p class="plic">
                    <span class="ciur-pic">￥100.00</span>
              ...
              <div class="item">
               <a href="details?productId=28"> <img src="img/tuan_img4.jpg" alt=""></a>
              <!--   <img src="img/tuan_img4.jpg" alt=""> -->
                <div class="text-box">
                  <p class="title">宝宝专用硅胶环保饭碗四套+调羹+筷子自助学吃饭套装</p>
                  <p class="plic">
                    <span class="ciur-pic">￥100.00</span>
      ...
      <div class="footer-wrap">
        <div class="footer w1200">
          ...
          <div class="list-box layui-clear" id="footerList">
            <div class="item">
             <a href="details?productId=29"> <img src="img/tuan_img5.jpg" alt=""></a>
           <!--    <img src="img/tuan_img5.jpg" alt=""> -->
              <div class="text">
            ...
            <div class="item">
             <a href="details?productId=30"> <img src="img/tuan_img6.jpg" alt=""></a>
             <!--  <img src="img/tuan_img6.jpg" alt=""> -->
              <div class="text">
                <div class="right-title-number">1</div>
                <div class="commod">
                  <p>宝宝打底衣棉麻透气不起球白色多色可选</p>
            ...
            <div class="item">
             <a href="details?productId=31"> <img src="img/tuan_img7.jpg" alt=""></a>
              <!-- <img src="img/tuan_img7.jpg" alt=""> -->
              <div class="text">
                <div class="right-title-number">1</div>
                <div class="commod">
                  <p>宝宝打底衣棉麻透气不起球白色多色可选</p>
