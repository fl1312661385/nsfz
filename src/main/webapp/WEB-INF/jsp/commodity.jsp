      ...
      <div class="commod-cont w1200 layui-clear">
        <div class="left-nav">
          ...
          <div class="list-box">
            <dl>
             <dt>奶粉辅食</dt>
             <dd><a href="specific?type=1&currentPage=1">进口奶粉</a></dd>
        ...
        <div class="right-cont-wrap">
          <div class="right-cont">
            ...
            <div class="prod-number">
              <span>共${util.count }个商品</span>
            </div>
            <div class="cont-list layui-clear" id="list-cont">
            
            
             <c:forEach items="${allproduct}" var="i" begin="${(util.currentPage-1)*util.pageSize }" end="${util.pageSize * util.currentPage-1}" step="1">
           ...
           <c:if test="${util.currentPage>1}" >
			...
			<a href="commodity?currentPage=${util.currentPage-1}" class="layui-btn layui-btn-warm">上一页</a>
           ...
           <a href="commodity?currentPage=${util.currentPage+1}" class="layui-btn layui-btn-warm" >下一页</a>
   			</c:if>
            </div>
          </div>
        </div>
